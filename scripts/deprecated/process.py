...
import os
import mne
from eelbrain import vessels as V, eellab as E
import subprocess
import tempfile
import fnmatch
import re
...
#Labels events    
    ...
    meg_ds['wordtype'] = E.factor(wtype, labels={None: 'None', 1: 'transparent', 2: 'opaque', 3: 'novel', 4: 'ortho', 5:'ortho'})
...
#            skiprows = i + 1
#    
#    data = E.load.txt.tsv(filename, names=True, types='auto', empty='nan',
...
#                k += 1
                ...
                displays.append(items[2])
#                k += 1
#        if (k % 4 == 0) and displays:
#            print displays[-1]
#            print items
#            print k
#            if any('Text' in item for item in items):
#                if not any('Response_Catcher' in item for item in items):
