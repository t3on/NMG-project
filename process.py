...
#Repairs voice trigger value problem, if needed
    if voiceproblem == True:
        ...
        ds['eventID'][index] = ds['eventID'][index]-64
...
#Labels events    
    ...
    ds['wordtype'] = E.factor(type, labels={7: 'None', 1: 'transparent', 2: 'opaque', 3: 'novel', 4: 'ortho', 5:'ortho'})
...
#Adds the raw files for the kit2fiff conversion
...
#Adds stim information
    ...
    stims = scipy.io.loadmat('/Users/teon/data/NMG/stims/stims_data.mat')['stims']
    stim_ds = E.dataset()
