...
e.exclude['subject'] = ['R0414']# , 'R0370', 'R0504', 'R0580', 'R0605']

l1 = e.read_label('lh.inferiortemporal.label')
l2 = e.read_label('lh.fusiform.label')
...
for wtype in wtypes:
    ...
    a = E.testnd.ttest_rel(Y=group_ds['stc'].sub(source=roi), X='wordtype',
                           ...
                           tstop=cstop, ds=group_ds, sub=idx, tail=1, samples=1000,
                           # tfce=True)
                           pmin=pmin)
    analyses.append(a)
